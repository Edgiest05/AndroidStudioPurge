...
*           On font atlas image generation [GenImageFontAtlas()], add a 3x3 pixels white RL_rectangle
...
Font LoadFontFromImage(Image image, Color key, int firstChar)
{
    ...
    // Parse image data to get RL_rectangle sizes
    ...
    for (int i = 0; i < font.glyphCount; i++)
    {
        ...
        // Get character RL_rectangle in the font atlas texture
...
//#define SUPPORT_FONT_ATLAS_SIZE_CONSERVATIVE
    ...
    if (packMethod == 0)   // Use basic packing algorithm
    {
        ...
        for (int i = 0; i < glyphCount; i++)
        {
            ...
            if (offsetX >= (atlas.width - glyphs[i].image.width - 2*padding))
            {
                ...
                // use an internal padding of 4 pixels, it means char RL_rectangle
    ...
    // Add a 3x3 white RL_rectangle at the bottom-right corner of the generated atlas,
    // useful to use as the white texture to draw shapes with raylib, using this RL_rectangle
...
void DrawTextCodepoint(Font font, int codepoint, Vector2 position, float fontSize, Color tint)
{
    ...
    // Character destination RL_rectangle on screen
    ...
    // Character source RL_rectangle from font texture atlas
...
// Get glyph RL_rectangle in font atlas for a codepoint (unicode character)
// NOTE: If codepoint is not found in the font it fallbacks to '?'
