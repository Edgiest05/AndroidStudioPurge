...
*
*       By default, raylib sets the default texture and RL_rectangle at InitWindow()[rcore] to one
...
RL_Rectangle texShapesRec = { 0.0f, 0.0f, 1.0f, 1.0f };    // Texture source RL_rectangle used on shapes drawing
...
// Draw a color-filled RL_rectangle with pro parameters
...
// Draw a vertical-gradient-filled RL_rectangle
...
// Draw a horizontal-gradient-filled RL_rectangle
// NOTE: Gradient goes from bottom (color1) to top (color2)
...
// Draw a gradient-filled RL_rectangle
...
// Draw RL_rectangle outline with extended parameters
...
// Draw RL_rectangle with rounded edges outline
...
// Check if point is inside RL_rectangle
...
// Check collision between circle and RL_rectangle
...
// Get collision RL_rectangle for two rectangles collision
