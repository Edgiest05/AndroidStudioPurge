...
// Draw a billboard (part of a texture defined by a RL_rectangle)
...
{
    // NOTE: Billboard size will maintain source RL_rectangle aspect ratio, size will represent billboard width
